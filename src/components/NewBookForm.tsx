...
function ModalNewBook ({onClose, onAdd}:ModalNewBookProps){
  ...
  const manejarEnvio = (e: any) => {
    ...
    <div className="book-modal-overlay" onClick={onClose}>
      ...
      >
        <form className="book-form" onSubmit={manejarEnvio}>
          <h2 className="book-form__title">Nuevo Libro</h2>
          ...
          <button className="book-form__button book-form__button--submit" type="submit">Guardar</button>
          <button className="book-form__button book-form__button--cancel" type="button" onClick={onClose}>
            Cancelar
          </button>
        </form>
      </div>
